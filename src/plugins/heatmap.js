...
SimpleHeat.prototype = {
	...
	gradient: function (t) {
		...
		return (
			...
			(this._grad = a.getImageData(0, 0, 1, 256, {
...
const heatLayer = function (t, i) {
	return new HeatLayer(t, i);
};
export { HeatLayer, heatLayer as default };
